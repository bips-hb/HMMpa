...
#'
#' @param size length of the time-series of observations x (also \code{T})
#' @param logL logarithmized likelihood of the model
...
#' where \code{T} indicates the length/size of the observation time-series and \code{p} 
#' denotes the number of independent parameters of the model. In case of a HMM as 
#' provided by this package, where \code{k} and \code{m} are defined as in the arguments 
#' above, \code{p} can be calculated as follows:
#'   \deqn{p = m^2+km-1.}{p = m^2 + km - 1.}
#' 
#' @return The AIC or BIC value of the fitted hidden Markov model.
...
#' @seealso \code{\link{AIC_HMM}}, \code{\link{HMM_training}}      
#'
#' @examples
